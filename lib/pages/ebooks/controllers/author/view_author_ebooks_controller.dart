...
class ViewAuthorEbooksController extends GetxController {
  ...
  Future<List<Ebook>> fetchEbooks() async {
    try {
      ...
      log("for fetch logged in author: $userId");

      var url = Uri.parse(APIService.fetchAuthorEbooksURL);
      ...
      //   Uri.parse(APIService.fetchAuthorEbooksURL),
      //   headers: {
      //     'user_id': userId.toString(),
      //   },
      // );
